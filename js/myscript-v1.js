        ...
        $.each(search_tools_array[0], function(i, item){
            ...
            if(search_method == 'blog'){
                ...
                if(res.match(v.toLowerCase())){
                    ...
                    if(search_type == 'd'){
                        new_js(".search_output .row").append('<div class="col-md-12 py-2"><img src="https://cdn.hitools.space/admin-images/'+admin_pic+'" alt="'+admin_name+'" class="img-fluid aurthor_img"><a href="'+base_url+'blog/'+item.p_link+'" class="icon_sty px-1">'+match+'</a></div>');
                    }else{
                        new_js(".mob_search .search_output .row").append('<div class="col-md-12 py-2 d-flex"><img src="https://cdn.hitools.space/admin-images/'+admin_pic+'" alt="'+admin_name+'" class="img-fluid aurthor_img"><a href="'+base_url+'blog/'+item.p_link+'" class="icon_sty px-1">'+match+'</a></div>');
                    }
                }
            }else{
